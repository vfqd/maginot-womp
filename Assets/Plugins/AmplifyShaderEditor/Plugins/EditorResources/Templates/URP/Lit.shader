	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			...
			Port:Forward:Alpha Clip Threshold
				...
				On:SetDefine:pragma shader_feature_local _ALPHATEST_ON
		...
		*/
		...
		Pass
		{
			...
			struct PackedVaryings
			{
				...
				#endif
				/*ase_interp(9,):sp=sp;wn.xyz=tc3.xyz;wt.xyz=tc4.xyz;wbt.xyz=tc5.xyz;wp.x=tc3.w;wp.y=tc4.w;wp.z=tc5.w;sc=tc6*/
				UNITY_VERTEX_INPUT_INSTANCE_ID
				UNITY_VERTEX_OUTPUT_STEREO
			};
		...
		Pass
		{
						...
						/*ase_frag_input*/ )
			{
				...
				/*ase_local_var:sc*/float4 ShadowCoords = float4( 0, 0, 0, 0 );
				/*ase_local_var:wn*/float3 WorldNormal = input.worldNormal;
				/*ase_local_var:wt*/float4 WorldTangent = input.worldTangent;
